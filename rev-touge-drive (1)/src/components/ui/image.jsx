...
const FALLBACK_IMAGE_URL =
  "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='600' viewBox='0 0 800 600'><rect width='800' height='600' fill='%230A0A0A'/><path d='M0 450 Q 200 380, 400 450 T 800 400 L 800 600 L 0 600 Z' fill='%23121212'/><path d='M0 500 Q 250 420, 500 520 T 800 480 L 800 600 L 0 600 Z' fill='%231A1A1A'/><path d='M220 600 L 370 440 L 430 440 L 580 600 Z' fill='%230F0F0F'/><path d='M398 440 L 396 600 M 404 440 L 404 600' stroke='%23D32F2F' stroke-width='3' stroke-dasharray='12,12'/></svg>"
